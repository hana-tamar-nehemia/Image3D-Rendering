...
class SphereTest {
    ...
    public void testFindIntersectionsRay() {
        Sphere sphere = new Sphere(2d, new Point3D(-2, 0, 0));
        ...
        List<Point3D> result = sphere.findIntersections(new Ray(new Point3D(-5, 0, 0), new Vector(5, 0, 1)));
        ...
        assertEquals(List.of(new Point3D(-2.0000000000000004,0.0,1.9999999999999996)),
                sphere.findIntersections(new Ray(new Point3D(-4, 0, 0), new Vector(2, 0, 2))),
                "Ray from sphere inside");
        // TC12: Ray starts at sphere and goes outside (0 points)
        assertNull(
                sphere.findIntersections(new Ray(new Point3D(-4, 0, 0), new Vector(-2, 1, 0))),
                "Ray from sphere outside");
//********************************************************************************************************************
        // **** Group: Ray's line goes through the center
        // TC13: Ray starts before the sphere (2 points)
        result = sphere.findIntersections(new Ray(new Point3D(1, 0, 0), new Vector(-9, 0, 0)));
        assertEquals(2, result.size(), "Wrong number of points");
        ...
        assertEquals(List.of(new Point3D(0.0,0.0,0.0)),
                sphere.findIntersections(new Ray(new Point3D(-4, 0, 0), new Vector(5, 0, 0))),
                "Line through O, ray from and crosses sphere");
        // TC15: Ray starts inside (1 points)
        assertEquals(List.of(new Point3D(-0.4,0.0,1.2)),
                sphere.findIntersections(new Ray(new Point3D(-1, 0, 0), new Vector(1, 0, 2))),
                "Line through O, ray from inside sphere");
        // TC16: Ray starts at the center (1 points)
        assertEquals(List.of(new Point3D(-4.0,0.0,0.0)),
                sphere.findIntersections(new Ray(new Point3D(-2, 0, 0), new Vector(-2, 0, 0))),
                "Line through O, ray from O");
        // TC17: Ray starts at sphere and goes outside (0 points)
        assertNull(sphere.findIntersections(new Ray(new Point3D(-4, 0, 0), new Vector(-1, 0, 0))),
...
//**********************************************************************************************************************
        ...
        // center line
        assertNull(sphere.findIntersections(new Ray(new Point3D(-5, 0, 0), new Vector(0, 0, 2))),
