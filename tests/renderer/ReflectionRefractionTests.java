    ...
    public void twoSpheres() {
        ...
        scene.geometries.add( //
                new Sphere(50, new Point3D(0, 0, -50)) //
                        ...
                        .set_material(new Material().setKd(0.4).setKs(0.3).setShininess(100).setKt(0.3)),
    ...
    public void twoSpheresOnMirrors() {
        ...
        scene.geometries.add( //
                new Sphere(400, new Point3D(-950, -900, -1000)) //
                        .set_emission(new Color(0, 0, 100)) //
                        .set_material(new Material().setKd(0.25).setKs(0.25).setShininess(20).setKt(0.5)),
                new Sphere(200, new Point3D(-950, -900, -1000)) //
                        .set_emission(new Color(100, 20, 20)) //
                        .set_material(new Material().setKd(0.25).setKs(0.25).setShininess(20)),
                new Triangle(new Point3D(1500, -1500, -1500), new Point3D(-1500, 1500, -1500),
                        new Point3D(670, 670, 3000)) //
                        .set_emission(new Color(20, 20, 20)) //
                        .set_material(new Material().setKr(1)),
                new Triangle(new Point3D(1500, -1500, -1500), new Point3D(-1500, 1500, -1500),
                        new Point3D(-1500, -1500, -2000)) //
                        .set_emission(new Color(20, 20, 20)) //
                        .set_material(new Material().setKr(0.5)));
    ...
    public void trianglesTransparentSphere() {
        ...
        scene.geometries.add( //
                new Triangle(new Point3D(-150, -150, -115), new Point3D(150, -150, -135), new Point3D(75, 75, -150)) //
                        .set_material(new Material().setKd(0.5).setKs(0.5).setShininess(60)), //
                new Triangle(new Point3D(-150, -150, -115), new Point3D(-70, 70, -140), new Point3D(75, 75, -150)) //
                        .set_material(new Material().setKd(0.5).setKs(0.5).setShininess(60)), //
                new Sphere(30, new Point3D(60, 50, -50)) //
                        .set_emission(new Color(java.awt.Color.BLUE)) //
                        .set_material(new Material().setKd(0.2).setKs(0.2).setShininess(30).setKt(0.6)));
